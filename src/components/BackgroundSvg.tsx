...
export const BackgroundSvg = (props: HTMLAttributes<HTMLOrSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 200" {...props}>
    <defs>
      ...
      <radialGradient id="Gradient6" cx="50%" cy="50%" fx="0.981338%" fy="50%" r=".5">
        ...
        <stop offset="100%" stopColor="rgba(255,0,0, 0)"></stop></radialGradient>
    </defs>
    <rect x="13.744%" y="1.18473%" width="100%" height="70%" fill="url(#Gradient1)" transform="rotate(334.41 50 50)">
      <animate attributeName="x" dur="20s" values="25%;0%;25%" repeatCount="indefinite"></animate>
      <animate attributeName="y" dur="21s" values="0%;25%;0%" repeatCount="indefinite"></animate>
      <animateTransform attributeName="transform" type="rotate" from="0 50 50" to="360 50 50" dur="7s" repeatCount="indefinite"></animateTransform>
    </rect>
    <rect x="-2.17916%" y="35.4267%" width="100%" height="70%" fill="url(#Gradient2)" transform="rotate(255.072 50 50)">
    ...
    <rect x="9.00483%" y="14.5733%" width="100%" height="70%" fill="url(#Gradient3)" transform="rotate(139.903 50 50)">
